...
package org.espier.clock.wheel;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTypeface(BusinessUtils.getTypeface(getContext().getApplicationContext()));
        }

        if (valuePaint == null) {
            valuePaint =
                    new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.FAKE_BOLD_TEXT_FLAG
                            | Paint.DITHER_FLAG);
            // valuePaint.density = getResources().getDisplayMetrics().density;
            valuePaint.setTextSize(TEXT_SIZE);
            // valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
            valuePaint.setShadowLayer(1.0f, 0, 2.0f, Color.WHITE);
            valuePaint.setTypeface(BusinessUtils.getTypeface(getContext().getApplicationContext()));
        }
    ...
    private void createLayouts(int widthItems, int widthLabel) {
            ...
            itemsLayout =
                    new StaticLayout(buildText(isScrollingPerformed), itemsPaint, widthItems,
                            widthLabel > 0
                                    ...
                                    : Layout.Alignment.ALIGN_CENTER, 1, ADDITIONAL_ITEM_HEIGHT,
                            false);
        } else {
        ...
        if (widthLabel > 0) {
            if (labelLayout == null || labelLayout.getWidth() > widthLabel) {
                labelLayout =
                        new StaticLayout(label, valuePaint, widthLabel,
    ...
    private void justify() {
        ...
        boolean needToIncrease =
                offset > 0 ? currentItem < adapter.getItemsCount() : currentItem > 0;
